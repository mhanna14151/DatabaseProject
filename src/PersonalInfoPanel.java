...
public class PersonalInfoPanel extends AbstractPanel {
  private View view;

  //central components
  private JScrollPane tablePane;
  private JTable table;
  private PersonalInfoTableModel model;

  PersonalInfoPanel(View view) {
    super();
  ...
  void createCenterPane() {
    ...
    //create table model
    try {
      model = new PersonalInfoTableModel(view);
  ...
  @Override
  void revalidateAll() {
    if(table != null) { table.revalidate(); table.repaint(); }
    if(tablePane != null) { tablePane.revalidate(); tablePane.repaint(); }
